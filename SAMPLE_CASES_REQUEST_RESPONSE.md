# GridWise LLM — Public Sample Cases (Request & Response)

This file contains all 10 sample test cases formatted with ready-to-copy **Request** JSON and corresponding expected **Response** JSON.

Endpoint: `POST http://localhost:3000/optimize-energy`

---

## Case 1: SAMPLE-01 — Solar cleaning + distractor
...
## Case 2: SAMPLE-02 — Battery charging maintenance
...
## Case 3: SAMPLE-03 — Emergency reserve as percentage
...
## Case 4: SAMPLE-04 — No-discharge protection test
...
## Case 5: SAMPLE-05 — Temporary feeder grid cap
...
## Case 6: SAMPLE-06 — Multiple notes with distractor
...
## Case 7: SAMPLE-07 — Reserve plus transformer cap
...
## Case 8: SAMPLE-08 — Separate charge/discharge outages
...
## Case 9: SAMPLE-09 — Reduction wording normalization
...
## Case 10: SAMPLE-10 — Multi-constraint evening operation
